...
const changesForMediumDevices = () => {
	if (window.matchMedia('(max-width: 1023px)').matches) {
		/* можем не удалять событие, так как у нас два progress bar, один под большие разрешения,
		  другой под телефоны, и тот который последний прописан в html не даёт проматывать музыку, 
		  почему так происходит пока не разобрался */
